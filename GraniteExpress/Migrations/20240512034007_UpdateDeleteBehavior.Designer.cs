...
namespace GraniteExpress.Migrations
{
    ...
    [Migration("20240512034007_UpdateDeleteBehavior")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraniteExpress.Models.User", b =>
                {
            ...
            modelBuilder.Entity("GraniteExpress.Models.Journal", b =>
                {
                    ...
                    b.HasOne("GraniteExpress.Models.User", "User")
                        .WithMany("Journals")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GraniteExpress.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
